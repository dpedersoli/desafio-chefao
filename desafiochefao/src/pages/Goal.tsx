...
const Goal = () => {
  ...
  return (
    <div>
      ...
      {/* PRECISO ARRUMAR UM JEITO MELHOR DE FECHAR ESSA TELA SEM USAR ALTERAÇÃO DO ESTADO -> pois o estado só retorna para 'false' depois de 1 click p/ depois do segundo click ele mudar de novo para 'true' e abrir o modal URGENTESS */}
